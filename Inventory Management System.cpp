#include "Inventory Management System.h"
#include <sstream>
#include <iostream>
#include <fstream>
#include <string>
...
void addProduct(Product * list, int *size){
	string pName,pGroup;
	int pPrice, pQty;
...
void renderMenu(Product * list, int *size){
 ...
 loadFileData(Product *list, int *size, string *content) {
	fstream file;
	string filename = "inventory.txt";
	string line;
	int count;
